	...
	btns.forEach(el=> {
		...
		const template = `<form class="modal-row__feedback-row add-feedback-form" style="display: block;">
                          <div class="modal-row__feedback-speakers"><i class="modal-row__feedback-ico" >
                              ...
                              </svg></i><a class="modal-row__feedback-choise" >Выбрать</a><i class="modal-row__feedback-direction change-direction">
                              <svg>
                          ...
                          <div class="modal-row__feedback-controls">
                            <div class="modal-row__feedback-controls_left">
                              <button class="modal-row__feedback-cancel feedback-btn">Отменить</button>
                              <button class="modal-row__feedback-save feedback-btn">Сохранить</button>
                            </div>
                            <div class="modal-row__feedback-controls_right">
                              <button class="modal-row__feedback-delete delete-btn">Удалить</button>
                            </div>
                          </div>
                        </form>`
