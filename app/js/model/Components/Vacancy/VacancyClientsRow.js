...
const tooltipContentFunc = ({
    ...
    return `<div class="row-popup" id="status-change-popup">
                    <form>
                        ...
                        <div class="input-group">
                            <p class="status department ${sixthClass}"><span>Отримав рішення</span></p>
                            <time class="got-permission">${sixthStatus}</time>
                        </div>
                        <div class="input-group">
                            <p class="status department ${seventhClass}"><span>Забрав рішення</span></p>
                            <time class="took-away-permission">${seventhStatus}</time>
                        </div>
                        <div class="input-group">
                            <p class="status department ${eighthClass}"><span>Білети куплені</span></p>
                            <time class="tickets-bought">${eighthStatus}</time>
                        </div>
                        <div class="input-group">
                            <p class="status busy ${ninethClass}"><span>Працевлаштований</span></p>
