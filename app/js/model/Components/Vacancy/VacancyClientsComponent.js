...
import RowVacancyClient from './VacancyClientsRowComponent'
...
export default class TableVacancyClient {
    ...
    update(data) {
        ...
        data.data && data.data.forEach(el => {
            ...
            } else if (el.vacancy.id_status === '5' || el.vacancy.id_status === '6' || el.vacancy.id_status === '7') {
                this.waitObj[el.id_trainees] = el
            } else if (el.vacancy.id_status === '8' || el.vacancy.id_status === '9' || el.vacancy.id_status === '10' || el.vacancy.id_status === '11' || el.vacancy.id_status === '12') {
                this.departmentObj[el.id_trainees] = el
            } else if (el.vacancy.id_status === '13') {
