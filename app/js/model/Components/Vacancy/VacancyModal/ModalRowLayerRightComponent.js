            ...
            el('div.main-info__choose-block',
                ...
                this.employerName = el('div.employer-name',
                    this.employerNameParagraph = el('p',
                        this.employerNameText = el('span', 'Виберіть роботодавця'))),
                el('div.full-info',
                    el('p.country-vacancy',
                        el('span', 'NO 293')),
                    el('p.products',
                        el('span.visa-type', 'Сезонна - '),
                        el('span.types', 'Квіти, Теплиці, Молочні корови, Мясні корови')))),
        ...
        setAttr(this.employerNameText, {
            innerText: data.employer.enterprise ?
                data.employer.enterprise : data.employer.name ?
                    data.employer.name : 'Виберіть роботодавця'
        })
        // }
        this.data = data
    }
