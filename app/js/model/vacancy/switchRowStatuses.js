                ...
                if (elem.classList.contains('active') && !flag) {
		          ...
		          <form>
                    ...
                    if (arr[ind].textContent === 'Подготовка CV') {
                        ...
                        changeClientStatus({id: client_id, status: '2'})
                        ...
                        changeClientStatus({id: client_id, status: '3'})
                        ...
                        changeClientStatus({id: client_id, status: '4'})
                        ...
                        changeClientStatus({id: client_id, status: '5'})
                        ...
                        changeClientStatus({id: client_id, status: '7'})
                        //Получаем все елементы после которого будем вставлять строку
                        ...
                        changeClientStatus({id: client_id, status: '8'})
                ...
                if (elem.classList.contains('active') && !flag) {
		          ...
		          <form>
                    ...
                    if (arr[ind].textContent === 'CV отправлено') {
                        ...
                        changeClientStatus({id: client_id, status: '6'})
                        // Присваиваем класс родительскому элементу стрелки переключения
                        this.parentNode.classList.remove('wait')
                        this.parentNode.classList.add('department')
                        ...
                        changeClientStatus({id: client_id, status: '9'})
                        this.parentNode.classList.remove('department')
   ...
   if(!this.classList.contains('del-status')) {
	...
	let oldChild = parentRow.removeChild(row)
     ...
     if (this.textContent === 'Подготовка CV') {
        ...
        changeClientStatus({id: client_id, status: '2'}).then(res => {
        ...
        changeClientStatus({id: client_id, status: '3'}).then(res => {
        ...
        changeClientStatus({id: client_id, status: '4'}).then(res => {
        ...
        changeClientStatus({id: client_id, status: '5'}).then(res => {
        ...
        changeClientStatus({id: client_id, status: '6'}).then(res => {
        ...
        changeClientStatus({id: client_id, status: '7'}).then(res => {
        ...
        changeClientStatus({id: client_id, status: '8'}).then(res => {
        ...
        changeClientStatus({id: client_id, status: '9'}).then(res => {
